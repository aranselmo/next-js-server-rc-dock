...
const DockLayoutDynamic = dynamic(() => import('rc-dock').then(rcDock=>rcDock.DockLayout), { ssr: false });


const DockLayoutClientDynamic = () => {
...
export { DockLayoutClientDynamic };
